...
class PostSection extends Component{
  ...
  render(){
    ...
    {this.state.posts.map( (post,b) => <div key={b} className="post-bar">
    <div className="post_topbar">
      <div className="usy-dt">
        <img src={"./images/user"+post.user_id+".png"} alt="" />
    ...
    <div className="job_descp">
      ...
      <ul className="skill-tags">
        {post.skills.map((skl,ind) => (
          <li key={ind}> <a href="./index.html#" title="">{skl}</a></li>
        ))}
      </ul>
    </div>
